...
GetImageDataByTime(path, '3-13-19', '62x_Salac_Pa14wt_SaPa14wt=1-1,1-10,100-1,10-1_co_SCFM2_tile2x2_3-13-19', slices, timepoints, positions, SaThreshold,Pa14wtThreshold);
GetImageDataByTime(path, '3-19-19', '62x_Salac_Pa14wt_SaPa14wt=1-1,1-10,100-1,10-1_co_SCFM2_tile2x2_3-19-19', slices, timepoints, positions, SaThreshold,Pa14wtThreshold);                                           
GetImageDataByTime(path, '4-17-19', '62x_Salac_Pa14wt_SaPa14wt1-11-10100-110-1_co_SCFM2_tile2x2_4-17-19', slices, timepoints, positions, SaThreshold,Pa14wtThreshold);
                                           
GetImageDataByTime(path, '4-24-19', '62x_Salac_Pa14pqsLclean_SaPa14pqsLclean=1-1,1-10,100-1,10-1_co_SCFM2_tile2x2_4-24-19', slices, timepoints, positions, SaThreshold,Pa14mutThreshold);
GetImageDataByTime(path, '4-25-19', '62x_Salac_Pa14pqsLclean_SaPa14pqsLclean=1-1,1-10,100-1,10-1_co_SCFM2_tile2x2_4-25-19', slices, timepoints, positions, SaThreshold,Pa14mutThreshold);
GetImageDataByTime(path, '5-8-19', '62x_Salac_Pa14pqsLclean_SaPa14pqsLclean=1-1,1-10,100-1,10-1_co_SCFM2_tile2x2_5-8-19', slices, timepoints, positions, SaThreshold,Pa14mutThreshold);

function GetImageDataByTime(path, date, name, slices, timepoints, positions, thR, thG)
tic 
...
%}
ThresholdImage(path, date, name, slices, timepoints, 2,thR,thG);
toc
end
...
resultsfilePath = strcat(path, date,'/resultsByTime2');
