...
testFile2<-"/Users/jupabago/Documents/Whiteley/PROJECTS/Spatial paper Data/Microscopy Data/Other Data/3-13-19/aggregateSizes/t00_p1.csv"
...
GetAggregates<-function(sample){
  ...
  for (position in 0:5){
    ...
    for (timepoint in 0:17){
      currentTimePoint<-currentPosition[grep(paste0("t_",GetNumber(timepoint),"_"),currentPosition)]
...
testReadAggregateFile<-ReadAggregateFile(tes)
```
