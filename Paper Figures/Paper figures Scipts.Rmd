...
test1Unique$Species <- factor(test1Unique$Species, levels = c("Pa", "Sa"),
                                         labels = c('P. aeruginosa','S. aureus'))
...
sa.paPlot<-
  ...
  labs(y = expression(atop("Enrichment distance ",paste(italic("S. aureus") %->% italic("P. aeruginosa "),"("*mu*"m)")))) +
