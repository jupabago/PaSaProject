...
wt1.2Whole<-read.csv(paste0("/Users/jupabago/Documents/Whiteley/PROJECTS/PaSaProject/Spatial paper Data/Microscopy Data/PropOcDataAll/wt1-1000-2.csv"),header = T)
wt2.2Whole<-read.csv(paste0("/Users/jupabago/Documents/Whiteley/PROJECTS/PaSaProject/Spatial paper Data/Microscopy Data/PropOcDataAll/wt2-1000-2.csv"),header = T)
wt3.2Whole<-read.csv(paste0("/Users/jupabago/Documents/Whiteley/PROJECTS/PaSaProject/Spatial paper Data/Microscopy Data/PropOcDataAll/wt3-1000-2.csv"),header = T)


```

```{r Whole PropOc frequency functions }
...
#below are for first run:
wt1.1Whole.5<-GetAllHistPropOc(wt1.1Whole,5)
wt2.1Whole.5<-GetAllHistPropOc(wt2.1Whole,5)
wt3.1Whole.5<-GetAllHistPropOc(wt3.1Whole,5)
mut1.1Whole.5<-GetAllHistPropOc(mut1.1Whole,5)
mut2.1Whole.5<-GetAllHistPropOc(mut2.1Whole,5)
mut3.1Whole.5<-GetAllHistPropOc(mut3.1Whole,5)
#second run
wt1.2Whole.5<-GetAllHistPropOc(wt1.2Whole,5)
wt2.2Whole.5<-GetAllHistPropOc(wt2.2Whole,5)
wt3.2Whole.5<-GetAllHistPropOc(wt3.2Whole,5)

#log sequence
wt1.1Whole.5log<-GetAllHistPropOc(wt1.1Whole,5)  
wt2.1Whole.5log<-GetAllHistPropOc(wt2.1Whole,5)
wt3.1Whole.5log<-GetAllHistPropOc(wt3.1Whole,5)
mut1.1Whole.5log<-GetAllHistPropOc(mut1.1Whole,5)
mut2.1Whole.5log<-GetAllHistPropOc(mut2.1Whole,5)
mut3.1Whole.5log<-GetAllHistPropOc(mut3.1Whole,5)

#log starting at .0001
wt1.1Whole.5log2<-GetAllHistPropOc(wt1.1Whole,5)  
wt2.1Whole.5log2<-GetAllHistPropOc(wt2.1Whole,5)
wt3.1Whole.5log2<-GetAllHistPropOc(wt3.1Whole,5)
mut1.1Whole.5log2<-GetAllHistPropOc(mut1.1Whole,5)
mut2.1Whole.5log2<-GetAllHistPropOc(mut2.1Whole,5)
mut3.1Whole.5log2<-GetAllHistPropOc(mut3.1Whole,5)
```

```{r Whole PropOc frequency Figures}
PlotAllPropOcData <- function(df, timepoint, relation ) {
  plot<-ggplot()+ 
...
PlotAllPropOcData(wt1.1Whole.5 %>% filter (Source == "finalGG"), 5, "Wt 1-1 PA->PA")
PlotAllPropOcData(wt2.1Whole.5 %>% filter (Source == "finalGG"), 5, "Wt 2-1 PA->PA")
PlotAllPropOcData(wt3.1Whole.5 %>% filter (Source == "finalGG"), 5, "Wt 3-1 PA->PA")

PlotAllPropOcData(wt1.2Whole.5 %>% filter (Source == "finalGG"), 5, "Wt 1-2 PA->PA")
PlotAllPropOcData(wt2.2Whole.5 %>% filter (Source == "finalGG"), 5, "Wt 2-2 PA->PA")
PlotAllPropOcData(wt3.2Whole.5 %>% filter (Source == "finalGG"), 5, "Wt 3-2 PA->PA")

PlotAllPropOcData(mut1.1Whole.5 %>% filter (Source == "finalGG"), 5, "Mut 1-1 PA->PA")
PlotAllPropOcData(mut2.1Whole.5 %>% filter (Source == "finalGG"), 5, "Mut 2-1 PA->PA")
PlotAllPropOcData(mut3.1Whole.5 %>% filter (Source == "finalGG"), 5, "Mut 3-1 PA->PA")

PlotAllPropOcData(wt1.1Whole.5 %>% filter (Source == "finalRG"), 5, "Wt 1-1 SA->PA")
PlotAllPropOcData(wt2.1Whole.5 %>% filter (Source == "finalRG"), 5, "Wt 2-1 SA->PA")
PlotAllPropOcData(wt3.1Whole.5 %>% filter (Source == "finalRG"), 5, "Wt 3-1 SA->PA")

PlotAllPropOcData(wt1.2Whole.5 %>% filter (Source == "finalRG"), 5, "Wt 1-2 SA->PA")
PlotAllPropOcData(wt2.2Whole.5 %>% filter (Source == "finalRG"), 5, "Wt 2-2 SA->PA")
PlotAllPropOcData(wt3.2Whole.5 %>% filter (Source == "finalRG"), 5, "Wt 3-2 SA->PA")

PlotAllPropOcData(mut1.1Whole.5 %>% filter (Source == "finalRG"), 5, "Mut1-1 SA->PA")
PlotAllPropOcData(mut2.1Whole.5 %>% filter (Source == "finalRG"), 5, "Mut2-1 SA->PA")
PlotAllPropOcData(mut3.1Whole.5 %>% filter (Source == "finalRG"), 5, "Mut3-1 SA->PA")

PlotAllPropOcData(wt1.1Whole.5 %>% filter (Source == "finalRR"), 5, "Wt 1-1 SA->SA")
PlotAllPropOcData(wt2.1Whole.5 %>% filter (Source == "finalRR"), 5, "Wt 2-1 SA->SA")
PlotAllPropOcData(wt3.1Whole.5 %>% filter (Source == "finalRR"), 5, "Wt 3-1 SA->SA")

PlotAllPropOcData(mut1.1Whole.5 %>% filter (Source == "finalRR"), 5, "Mut1-1 SA->SA")
PlotAllPropOcData(mut2.1Whole.5 %>% filter (Source == "finalRR"), 5, "Mut2-1 SA->SA")
PlotAllPropOcData(mut3.1Whole.5 %>% filter (Source == "finalRR"), 5, "Mut3-1 SA->SA")

PlotAllPropOcData(wt1.1Whole.5 %>% filter (Source == "finalGR"), 5, "Wt 1-1 PA->SA")
PlotAllPropOcData(wt2.1Whole.5 %>% filter (Source == "finalGR"), 5, "Wt 2-1 PA->SA")
PlotAllPropOcData(wt3.1Whole.5 %>% filter (Source == "finalGR"), 5, "Wt 3-1 PA->SA")

PlotAllPropOcData(mut1.1Whole.5 %>% filter (Source == "finalGR"), 5, "Mut1-1 PA->SA")
PlotAllPropOcData(mut2.1Whole.5 %>% filter (Source == "finalGR"), 5, "Mut2-1 PA->SA")
PlotAllPropOcData(mut3.1Whole.5 %>% filter (Source == "finalGR"), 5, "Mut3-1 PA->SA")
...
GetMaxDensity <- function(df) {#this one is essentially the same as the one below, but thos one doesnt allow repeated max density values
...
ggplot()+#log transform
    ...
    labs(title ="50 percentile Density (Log)")+
    facet_wrap( ~ Source, ncol = 2)+
    theme_cowplot()+
    theme(plot.title = element_text(hjust = 0.5))
```
...
ggplot()+
    ...
    labs(title ="50 percentile Enrichment by strain")+
    facet_wrap( ~ Source, ncol = 2)+
    #scale_color_gradientn(colours = rainbow(5))+
    scale_shape_manual(values=c(0,1,2, 15,16,17))+
    theme_cowplot()+
